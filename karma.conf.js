...
module.exports = function (config) {
    config.set({
        ...
        files: [
            ...
            { pattern: "src/EPiServer.Labs.BlockEnhancements/ClientResources/**/*.js", included: false, watched: true}
        ],
        ...
        preprocessors: {
            ...
            "src/EPiServer.Labs.BlockEnhancements/ClientResources/**/*.js": ["coverage"]
        },
